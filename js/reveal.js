...
var Reveal = (function(){
	...
	function setupDOM() {
		...
		if( !dom.wrapper.querySelector( '.controls' ) && config.controls ) {
			...
			controlsElement.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="80" height="80">' + 
			                '<rect class="diamond navigate-left" width="10" height="10" x="30" y="15" transform="rotate(45)" />' +
			                '<rect class="diamond" width="10" height="10" x="15" y="15" />' + 
			                '<rect class="diamond navigate-up" width="10" height="10" x="30" y="-25" transform="rotate(45)" />' +
			                '<rect class="diamond" width="10" height="10" x="55" y="15" />' +
			                '<rect class="diamond navigate-right" width="10" height="10" x="70" y="-25" transform="rotate(45)" />' +
			                '<rect class="diamond" width="10" height="10" x="55" y="55" />' +
			                '<rect class="diamond navigate-down" width="10" height="10" x="70" y="15" transform="rotate(45)" />' +
			                '<rect class="diamond" width="10" height="10" x="15" y="55" />' +
			            '</svg>';
	...
	function onDocumentKeyDown( event ) {
		...
		switch( event.keyCode ) {
			...
			// t
			case 84: toggleBeerTracker(); break;
			default:
				triggered = false;
		}
	...
	function toggleBeerTracker( event ) {
	
	  dom.wrapper.querySelector( '.progress' ).classList.toggle( 'beerTracker' );
